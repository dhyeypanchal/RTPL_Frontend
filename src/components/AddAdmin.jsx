    ...
    return (
        <>
            ...
            <div className="max-w-2xl md mt-5 mx-auto p-3 bg-white rounded-lg">
                ...
                <h1 className="text-center mb-6 text-2xl font-bold">New Sub Admin Form</h1>
                {!isEmployee ?
                <div className="my-5 mx-[2rem] flex items-center">
                    <input
                ...
                <Formik onSubmit={handleSubmit}>
                    <Form onSubmit={handleSubmit}>
                        ...
                        <div className="flex flex-wrap justify-center items-center">
                            ...
                            <div className="mb-4 w-72 mr-2">
                                <label htmlFor="role" value={selectedValueforRole} className="block mb-1 font-medium">
                                    Role:
                                </label>
